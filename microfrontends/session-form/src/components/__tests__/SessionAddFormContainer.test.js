...
import { sessionMockAdd as sessionMock } from 'components/__mocks__/sessionMocks';
...
describe('SessionAddFormContainer', () => {
  ...
  it('saves data', async () => {
    ...
    const { findByTestId, findByLabelText, queryByText, rerender } = render(
      <SessionAddFormContainer onError={onErrorMock} onUpdate={onCreateMock} config={configMock} />
    );
