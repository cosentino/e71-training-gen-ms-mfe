...
/**
 * REST controller for managing {@link com.m2cosentino.e71training.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SessionResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSession";
        ...
        Optional<Session> result = sessionRepository
            ...
            .map(existingSession -> {
                ...
                if (session.getTrack() != null) {
                    existingSession.setTrack(session.getTrack());
                }
